...
import { EquipmentImagePicker } from "@/components/equipment/EquipmentImagePicker";
...
describe("EquipmentImagePicker", () => {
  ...
  describe("Default Icons Tab", () => {
    it("renders default icons grid", () => {
      render(<EquipmentImagePicker {...defaultProps} />);
    ...
    it("shows equipment-specific categories (weapon, armor, gear, misc)", () => {
      render(<EquipmentImagePicker {...defaultProps} />);
  ...
  describe("Clear/Remove", () => {
    ...
    it("does not show remove button when no image", () => {
      render(<EquipmentImagePicker {...defaultProps} value={undefined} />);
  ...
  describe("Disabled State", () => {
    it("disables all interactions when disabled prop is true", () => {
      render(<EquipmentImagePicker {...defaultProps} disabled={true} />);
