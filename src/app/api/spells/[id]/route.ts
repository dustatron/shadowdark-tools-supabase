...
const SpellUpdateSchema = z.object({
  ...
  slug: z.string().min(1).max(100).regex(/^[a-z0-9_-]+$/, 'Slug must be lowercase with hyphens or underscores').optional(),
  description: z.string().min(1).optional(),
  classes: z.array(z.string()).min(1, 'At least one class must be specified').optional(),
