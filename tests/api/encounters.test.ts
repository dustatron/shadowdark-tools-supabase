...
describe("Encounter API Contract Tests", () => {
  ...
  describe("GET /api/encounters/tables", () => {
    ...
    it("should filter tables by environment", async () => {
      const response = await fetch(
        "/api/encounters/tables?environment=dungeon",
      );
        ...
        entries: [
          {
            roll_min: 1,
            roll_max: 3,
            encounter_description: "Small group of goblins",
          },
          {
            roll_min: 4,
            roll_max: 6,
            encounter_description: "Wandering skeleton",
          },
        ],
      };
  ...
  describe("GET /api/encounters/tables/[id]/roll", () => {
    ...
    it("should return 404 for non-existent table", async () => {
      const response = await fetch(
        "/api/encounters/tables/non-existent-id/roll",
      );
