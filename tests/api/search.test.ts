...
describe('Search API Contract Tests', () => {
  describe('GET /api/search/monsters', () => {
    ...
    it('should support advanced filtering in search', async () => {
      const response = await fetch('/api/search/monsters?q=humanoid&minLevel=2&maxLevel=6&types=humanoid');
    ...
    it('should return empty results for no matches', async () => {
      const response = await fetch('/api/search/monsters?q=nonexistentmonster123');
